...
function Repairmantenance() {
  return (
    <>
      <Container fluid>
        <Row className="dirverresfullc pt-5 pb-5">
          <Col className="mx-auto pt-4 mt-5 mb-5 col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
            <Textbox
              textname="Vehicle No"
              type="text"
            ...
            <Textbox textname="Date" type="text" boxcolor="textboxcolor" />
...
export default Repairmantenance;
